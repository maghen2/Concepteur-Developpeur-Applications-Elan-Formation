  ...
  <?php
   if(isset($_SESSION['produit'])){  // on verifie si des produits existent dans la session
    ...
    foreach($_SESSION['produit'] as $id => $produit){
      ...
      echo "<tr> <td>".$id."</td> <td>".$produit['nom']."</td> <td>".$produit['prix']."€</thd> <td>".$produit['quantite']."</td> <td>".$produit['Prix_total']." €</td> <td><a href='traitement.php?id=".$id.'&action=supprimer\'><img width="30px" src="src/supprimer.png" alt="Supprimer l\'artcle" title="Supprimer l\'artcle"> </a></td></tr>';
    }
